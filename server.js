...
app.use("/api/buyers", require("./routes/buyerRoutes"));
app.use("/api/blog-posts", require("./routes/blog.routes"));
app.use("/api/contact", require("./routes/contactRoutes"));
app.use("/api/visits", require("./routes/propertyVisits"));
app.use("/api/rss-sources", require("./routes/rssRoutes"));
app.use("/api/home-hero", require("./routes/homeHero.routes"));
app.use("/api/ai", require("./routes/description.routes"));
app.use("/api/ai-blogs", require("./routes/aiBlogs.routes"));
