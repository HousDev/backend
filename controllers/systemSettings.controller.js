...
//     } else if (data.company_logo === "" || data.company_logo === null) {
//       data.company_logo = null; // ✅ remove logo
//     } else {
...
//     } else if (data.company_favicon === "" || data.company_favicon === null) {
//       data.company_favicon = null; // ✅ remove favicon
//     } else {
...
//       data.property_auto_approval === "true" ||
//       data.property_auto_approval === 1
//         ? 1
//         : 0;
